...
<div class="content py-3" >
    <div class="container-fluid">
        <div class="card card-outline card-outline rounded-0 shadow blur">
            <div class="card-header" style="background-color: #EDE9E8;">
                <h5 class="card-title"><?= isset($id) ? "Update ". $code . " Sale" : "New Sale" ?></h5>
            </div>
            <div class="card-body" style="background-color: #EDE9E8;">
                <div class="container-fluid" >
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="client_name" id="client_name" style="background-color: #EDE9E8;" class="form-control form-control-sm rounded-0" value="<?= isset($client_name) ? $client_name : "Guest" ?>" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="border rounded-0 shadow px-1 py-1" id="sales-panel" style="background-color: #765341;">
                            <div class="d-flex h-100 w-100">
                                <div class="col-7 px-0 h-100" id="panel-left" style="background-color: #8b6c5c;">
                                    <div class="card card-primary bg-transparent border-0 h-100 card-tabs rounded-0">
                                        <div class="card-header bg-gradient-dark p-0 pt-1">
                                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist" style="background-color: #4c3228;">
                                                <?php
                                                $has_active = false;
                                                        ...
                                                        <?php if(isset($prod_arr[$k])): ?>
                                                            <?php foreach($prod_arr[$k] as $row): ?>
                                                                <div class=" col-lg-3 col-md-4 col-sm-12 col-xs-12 px-2 py-3">
                                                                    <a href="javascript:void(0)"  class="card rounded-pill text-dark text-decoration-none prod-item" style="background-color:  #e8e4c9;" data-price="<?= $row['price'] ?>" data-id="<?= $row['id'] ?>">
                                ...
                                <div class="col-5 h-100">
                                    <table class="table table-bordered table-striped mb-0">
                                        ...
                                        <thead>
                                            <tr style="background-color: #4c3228;">
                                                <th class="text-center px-2 py-1" style="color: #fff;">QTY</th>
                                                <th class="text-center px-2 py-1" style="color: #fff;">Product</th>
                                                <th class="text-center px-2 py-1" style="color: #fff;">Total</th>
                                                <th class="text-center px-2 py-1" style="color: #fff;"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr></tr>
                                    ...
                                    <div id="item-list" class="overflow-auto" style="background-color: #8b6c5c; color: #fff;" >
                                    ...
                                    <h3 class="d-flex w-100 align-items-center">
                                        <div class="col-4" style="color: #EDE9E8;">Tendered:</div>
                                        <div class="col-8">
                                    ...
                                    <h3 class="d-flex w-100 align-items-center">
                                        <div class="col-4" style="color: #EDE9E8;">Change:</div>
                                        <div class="col-8">
                                    ...
                                    <h3 class="d-flex w-100 align-items-center">
                                        ...
                                        <div class="col-8">
                                            <select name="payment_type" id="payment_type" class="form-control rounded-0" required="required">
                                                ...
                                                <option value="2" <?= isset($payment_type) && $payment_type == 2 ? "selected" : "" ?>>Gcash</option>
                                            </select>
                                        </div>
                                    </h3>
            ...
            <div class="card-footer py-2 text-right" style="background-color: #EDE9E8;">
              <br>
